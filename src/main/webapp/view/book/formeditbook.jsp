...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
		...
		<head>
			...
			<link href="${path}/css/editbook.css" rel="stylesheet"> </head>
						...
						<div class="row">
							<div class="col-md-3">
								...
								<c:forEach items="${book.genres}" var="genre">
									<p>
										<input type="text" class="form-control" name="genresNames" value="${genre.genreName}" />
									</p>
								</c:forEach>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-3">
								<c:forEach items="${book.publishers}" var="publisher">
									<p>
										<input type="text" class="form-control" name="publishersNames" value="${publisher.publisherName}" />
									</p>
								</c:forEach>
							</div>
						</div>
