...
<html>
    <head>
        ...
        <link href="${path}/css/edituserbyadmin.css" rel="stylesheet">
    </head>
    <body>
        ...
        <form:form action="${path}/user/edituserbyadmin" modelAttribute="user" method="POST">
            ...
            <div class="row">
            					        <div class="col-md-3">
                                            ...
                                            <p><form:input path="firstName" class="form-control" value="${user.firstName}" /></p>
                                        </div>

            						    <div class="col-md-3">
                                            <p><label for="lastName">Last name</label></p>
                                            <p><form:input path="lastName" class="form-control" value="${user.lastName}" /></p>
                                        </div>

            						    <div class="col-md-3">
                                            <p><label for="middleName">Middle name</label></p>
                                            <p><form:input path="middleName" class="form-control" value="${user.middleName}" /></p>
                                        </div>
            						</div>
            						...
            						<div class="row">
            						    <div class="col-md-5">
                                            ...
                                            <p><form:input path="email" class="form-control" value="${user.email}" /></p>
                                            <p class="error">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <p><form:input path="phoneNumber" class="form-control" value="${user.phoneNumber}" /></p>
                                            <p class="error">
            						...
            						<div class="row">
            						    <div class="col-md-3">
                                            ...
                                            <p><form:input path="username" class="form-control" value="${user.username}" /></p>
                                            <p class="error">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${not empty superUser}">
                                                               <c:if test="${not empty admin}">
                                                                <p><label for="role">Administrator</label></p>
                                                                <input type="checkbox" class="form-control" name="role" value="ROLE_ADMIN" checked/><br><br>
                                                               </c:if>
                                                                <c:if test="${empty admin}">
                                                                <p><label for="role">Administrator</label></p>
                                                                <input type="checkbox" class="form-control" name="role" value="ROLE_ADMIN"/><br><br>
                                                               </c:if>
                                                            </c:when>
                                                        </c:choose>
                                        </div>
            ...
            <div id="but">
                <p><button type="button" class="btn btn-primary" onclick="addDropPasswordCheckbox()">Drop password</button></p>
            </div>
